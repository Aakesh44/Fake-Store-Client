...
const MenClothMini = () => {
  ...
  return (
    ...
    <div className=' h-full w-1/3 md:py-10 mr-auto sticky bg-fuchsia-4000  shadow-md  flex-shrink-0 flex flex-col items-center'>
      ...
      <span className=' text-center my-auto md:text-xl lg:text-3xl'> Best of Mens clothing</span>
      <button className=' text-fuchsia-800 my-auto md:text-lg lg:text-2xl'><Link to='/MenClothMain' >View All </Link></button>
    </div>
