...
const Data=dataElec.filter(n=>n.category==="jewelery").slice(0,4)
  return (
    ...
    <div className=' h-full w-1/3 md:py-10 mr-auto sticky bg-fuchsia-4000  shadow-md  flex-shrink-0 flex flex-col items-center'>
      <img src={jewel2} alt="" className=' my-auto lg:h-2/3 '/>
      <span className=' text-center my-auto md:text-xl lg:text-3xl'> Best of Jewelery</span>
      <button className=' text-fuchsia-800 my-auto md:text-lg lg:text-2xl'><Link to='/JewelsMain' >View All </Link></button>
    </div>
